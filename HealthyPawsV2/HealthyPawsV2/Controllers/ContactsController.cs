...
namespace HealthyPawsV2.Controllers
{
    public class ContactsController : Controller
    {
        ...
        public ContactsController(HPContext context)
        {
            _context = context;
        }

        //GET: Contact Page : SignedOut
		public async Task<IActionResult> Contact()
		{
            return View(await _context.Contacts.ToListAsync());
        }
        //GET: Contact Page : SignedIN
        public async Task<IActionResult> ContactInside()
        {
            return View(await _context.Contacts.ToListAsync());
        }
        // GET: Contacts
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("contactId,Email,Phone,WhatsApp")] Contact contact)
        {
